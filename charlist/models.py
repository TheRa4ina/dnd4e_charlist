...
from .constants import UNIQUE_KEY_ERROR
...
class Session(models.Model):
    ...
    users = models.ManyToManyField(
        settings.AUTH_USER_MODEL, through="Session_User")
    ...
    def save(self, *args, **kwargs) -> None:
        ...
        for _ in range(retries):
            try:
                ...
                break
            except IntegrityError:  # idefk how this could happen but if it'll
                self.key = self.generate_secret_key()
...
class Character(models.Model):
    ...
    gender = models.ForeignKey(
        Gender, on_delete=models.CASCADE, default="male")
